...
project = 'apogee_drp'
copyright = '{0}, {1}'.format('2020', 'David Nidever')
...
.. |apogee_drp_version| replace:: {__version__}
"""
...
htmlhelp_basename = '{0}pdoc'.format('apogee_drp')
...
man_pages = [
    (master_doc, 'apogee_drp', u'{0} Documentation'.format(project),
     [author], 1)
]
...
if use_releases == 'yes':
    ...
    releases_github_path = 'sdss/apogee_drp'
