...
pro mklsf,lsfid,waveid,darkid=darkid,flatid=flatid,psfid=psfid,fiberid=fiberid,$
  ...
  clobber = 0 ; 11
  MKPSF,psfid,darkid=darkid,flatid=flatid,fiberid=fiberid,clobber=clobber,/unlock  ;; why is clobber set??
  w = approcess(lsfid,dark=darkid,flat=flatid,psf=psfid,flux=0,/doproc,/skywave,clobber=clobber)
