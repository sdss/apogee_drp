...
; READCAL
;
; Reads a master list file specifying calibration frames
; to be used on different dates, and the information needed
; to create these frames, returns info in structures for
; each cal product.
; The actual construction of the calibration products is done
; with mkcal.pro.
; 
; INPUTS:
...
;  Doc string updates, general cleanup by D. Nidever, Sep 2020
;-
