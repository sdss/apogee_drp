...
;endif
        ...
        if keyword_set(pl) then begin
          ...
          legend_old,['Before Subtraction','After Subtraction'],textcolor=[255,250],charsize=1.2,$
                 pos=[30,yr[1]-range(yr)*0.02]
          ;stop
        endif
    ...
    For j=0,2 do begin
      ...
      For k=0,nuselines-1 do begin
        ...
        if keyword_set(pl) then begin
          ...
          legend_old,['Before Subtraction','After Subtraction','Sky Line'],textcolor=[250,200,150],/top,/left,charsize=1.2
          ;wait,0.3
          ;stop
        endif
      ...
      if keyword_set(pl) then begin
        ...
        legend_old,['Before Subtraction','After Subtraction','Sky Lines'],textcolor=[255,150,250],charsize=1.2,$
               pos=[30,yr[1]-range(yr)*0.02]
        ;stop
      endif
