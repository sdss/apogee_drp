...
;print,i,j,mindiff
    ...
    if keyword_set(lpl) and keyword_set(pl) then begin
      ...
      if keyword_set(uselsf) then begin
        ...
        legend_old,['Spectrum','Error','Spectrum - Other lines Removed','Residual','Gaussian Fit','LSF Fit'],$
                   textcolor=[255,150,200,100,180,250],/top,/left
      endif else begin
        legend_old,['Spectrum','Error','Spectrum - Other lines Removed','Residual','Gaussian Fit'],$
