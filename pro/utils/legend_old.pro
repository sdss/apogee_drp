...
;-
pro legend_old, items, BOTTOM_LEGEND=bottom, BOX = box, CENTER_LEGEND=center, $
...
;       =====>> CLEAR AREA
        ...
        if n_elements(background_color) eq 0 then background_color=-1
        polyfill,[x,xend,xend,x,x],y + [0,0,ywidth,ywidth,0],/norm,color=background_color
