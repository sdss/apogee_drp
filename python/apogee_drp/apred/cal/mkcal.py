...
def readcal(calfile):
    ...
    dtdict['sparsegrid'] = np.dtype([('id','U30'),('mjd1',int),('mjd2',int),('mjds','U1000')])
    
    # -- Darks --
    #  mjd1, mjd2, name, frames
    #  dark       55600 56860 12910009 12910009-12910037
    #  dark       56861 99999 15640003 15640003-15640021
    dtdict['dark'] = np.dtype([('mjd1',int),('mjd2',int),('name','U50'),('frames','U100')])
    ...
    dtdict['flat'] = np.dtype([('mjd1',int),('mjd2',int),('name','U50'),('frames','U100'),
    ...
    dtdict['sparse'] = np.dtype([('mjd1',int),('mjd2',int),('name','U50'),('frames','U100'),
                                 ('darkframes','U100'),('dmax',int),('maxread','U100')])
    # -- ModelPSF --
    # modelpsf start end   name      sparse    psf
    # modelpsf   59549 99999 39870034  39870034  39870034
    dtdict['modelpsf'] = np.dtype([('mjd1',int),('mjd2',int),('name','U50'),('sparse','U100'),
                                   ('psf','U100')])
    # -- Fiber --
    #  mjd1, mjd2, name
    #  fiber      55600 55761 01970078
    #  fiber      55797 56860 02410024
    dtdict['fiber'] = np.dtype([('mjd1',int),('mjd2',int),('name','U50')])

    # -- Badfiber --
    #  mjd1, mjd2, frames
    #  badfiber   55600 57008   0
    #  badfiber   57009 57177   195
    dtdict['badfiber'] = np.dtype([('mjd1',int),('mjd2',int),('name','U100')])

    # -- Fixfiber --
    #  mjd1, mjd2, name
    #  fixfiber   56764 56773   1
    #  fixfiber   58038 58046   2
    dtdict['fixfiber'] = np.dtype([('mjd1',int),('mjd2',int),('name','U50')])

    # -- q3fix --
    #  mjd1, mjd2, name
    #  q3fix      56930 57600   1
    #  q3fix      59146 99999   1
    dtdict['q3fix'] = np.dtype([('mjd1',int),('mjd2',int),('name','U50')])

    # -- Wave --
    #  mjd1, mjd2, name, frames, psfid
    #  wave       55699 55699 01370096 1370096,1370099  1370098
    #  wave       55700 55700 01380079 1380079          1380081
    dtdict['wave'] = np.dtype([('mjd1',int),('mjd2',int),('name','U50'),('frames','U100'),
                               ('psfid',int)])
    # -- Multiwave --
    #  mjd1, mjd2, name, frames
    ...
    dtdict['persist'] = np.dtype([('mjd1',int),('mjd2',int),('name','U50'),('darkid',int),
                                  ('flatid',int),('thresh',float)])
    # -- Persistmodel --
    #  mjd1, mjd2, name
    #  persistmodel    55600 56860 57184
    #  persistmodel    56861 99999 0
    dtdict['persistmodel'] = np.dtype([('mjd1',int),('mjd2',int),('name','U50')])
    # -- Response --
    #  mjd1, mjd2, name, fluxid, psfid, temp
    #  response   55600 99999  0  0   0 0
    dtdict['response'] = np.dtype([('mjd1',int),('mjd2',int),('name','U50'),('fluxid',int),
