...
def telescopePos(field='17049', star='2M07311564+3145469'):
    ...
    ax1.text(1.01, 1.00, r'ALT($^{\circ}$)   FIBID  MJD', transform=ax1.transAxes, fontsize=fsz)
    ...
    for iexp in range(nexp):
        ...
        if len(g) > 0:
            ...
            txt = str("%.1f" % round(allexp['ALT'][g1][0],1)) + '    ' + str(obj['fiberid'][g][0]).zfill(3) + '    ' + str(allsnrg['mjd'][iexp])
    ...
    fig.subplots_adjust(left=0.073,right=0.88,bottom=0.06,top=0.96,hspace=0.08,wspace=0.00)
