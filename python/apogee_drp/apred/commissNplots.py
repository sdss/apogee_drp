...
def tellredtests1(field='21200', conf='3922', mjd='59648', fiber='273'):
    ...
    ax1.plot(wave0, flux0/med0, 'k', linewidth=0.5, label='all 90')
    ax2.plot(wave0, flux0/med0, 'k', linewidth=0.5)
    med = np.empty(5)
    ...
    for i in range(5):
        ...
        ax1.plot(wave, (flux/med0)+med0*0.075*(i+1), color=colors[i], linewidth=0.5, label=labels[i])
        ax2.plot(wave, flux/med0, linewidth=0.5, color=colors[i])
