...
#                q = mkhtml(mjd[i], apred)
    ...
    html.write('<HEAD><script type=text/javascript src=html/sorttable.js></script><title>MWM Summary Page by MJD</title></head>\n')
    ...
    html.write('<TR><TD>Logs (data)<TD>Exposures<TD>Night QA<TD>Plate QA plots (indiv) <TD>Plate QA (summed plates) <TD>Indiv stars<TD>Dome flats\n')
    for i in range(nmjd):
