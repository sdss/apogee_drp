...
#        html.write('<img src=galactic.gif width=45%>\n')
    ...
    #        html.write('<TD><center><A HREF=exposures/'+dirs.instrument+'/'+cmjd+'/html/'+cmjd+'.html> '+cmjd+' </a></center>\n')
        ...
        ax1.legend(loc=[-0.1,1.05], labelspacing=0.5, handletextpad=-0.1, facecolor='lightgrey',fontsize=fsz)

        fig.subplots_adjust(left=0.1,right=0.99,bottom=0.05,top=0.90,hspace=0.09,wspace=0.09)
