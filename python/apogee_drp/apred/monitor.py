...
#        if len(check) < 1: subprocess.call(['scp', pfiles[i], sdir5 + 'flatflux/'])
    ...
    if makecomplots is True:
        ...
        ax1.scatter(x, y, marker=symbol, c=gdata['H'][g], cmap='cool', s=symsz, edgecolors='k', alpha=0.75, zorder=10)
        ...
        sc2 = ax2.scatter(x, y, marker=symbol, c=gdata['H'][g], cmap='cool', s=symsz, edgecolors='k', alpha=0.75, zorder=10)
        ...
        ax3.scatter(x, y, marker=symbol, c=gdata['H'][g], cmap='cool', s=symsz, edgecolors='k', alpha=0.75, zorder=10)
        ...
        sc4 = ax4.scatter(x, y, marker=symbol, c=gdata['H'][g], cmap='cool', s=symsz, edgecolors='k', alpha=0.75, zorder=10)
