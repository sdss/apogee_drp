...
def monitor(instrument='apogee-n', apred='daily', clobber=True, makesumfiles=True, exptable=False,
    ...
    if makesumfiles is True:
        ...
        if os.path.exists(allsnrfile) is False:
            ...
            if allv4 is None:
                allv4pth = '/uufs/chpc.utah.edu/common/home/sdss/dr17/apogee/spectro/aspcap/dr17/synspec_rev1/allVisit-dr17-synspec_rev1.fits'
...
def getSnrStruct2(data1=None, data2=None, iexp=None, field=None, sumfile=None):
    ...
    if makecomplots is True:
        ...
        allvpath = '/uufs/chpc.utah.edu/common/home/sdss/dr17/apogee/spectro/aspcap/dr17/synspec_rev1/allStarLite-dr17-synspec_rev1.fits'
