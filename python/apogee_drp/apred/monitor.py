...
def monitor(instrument='apogee-n', apred='daily', clobber=True, makesumfiles=True, exptable=False,
    ...
    html.write('<li> Throughput:\n')
    html.write('<ul>\n')
    html.write('<li> <a href=#scisnr> S/N history</a>\n')
    html.write('<li> <a href=' + instrument + '/fiber/fiber_qrtz.html target="_blank">Fiber throughput from quartz lamp (external page)</a>\n')
    html.write('<li> <a href=' + instrument + '/fiber/fiber.html target="_blank">Fiber throughput from dome flats (external page)</a>\n')
    html.write('</ul>\n')
    html.write('<li> Lamp/FPI:\n')
    html.write('<ul>\n')
    ...
    html.write('<li> <a href=#dpos>Dome flat trace position </a>\n')
