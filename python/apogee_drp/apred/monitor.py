    ...
    if makeplots is True:
        ...
        if ((os.path.exists(qplotfile) == False) | (clobber == True)) & (os.path.exists(qfile)):
            ...
            for irow in range(nrows):
                ...
                if irow == 0:
                    sc1 = ax.scatter(xvals, yvals, marker='o', s=markersz*1.5, c=cvals, cmap='rainbow', vmin=0.5, vmax=2.0)
                else:
                    sc1 = ax.scatter(xvals, yvals, marker='o', s=markersz*1.5, c=cvals, cmap='rainbow')
