    ...
    if makecomplots is True:
       ###########################################################################################
        ...
        for ichip in range(nchips):
            ...
            ax.set_xlim(0, 300)
            ax1 = ax.twinx()
            ax.set_ylim(-0.00011, 0.00011)
            ax1.set_ylim(-0.00011, 0.00011)
            ax.minorticks_on()
            ax.xaxis.set_major_locator(ticker.MultipleLocator(20))
            ax.xaxis.set_minor_locator(ticker.MultipleLocator(1))
            ax1.xaxis.set_major_locator(ticker.MultipleLocator(20))
            ax1.xaxis.set_minor_locator(ticker.MultipleLocator(1))
            ax.yaxis.set_major_locator(ticker.MultipleLocator(0.00005))
            ax.yaxis.set_minor_locator(ticker.MultipleLocator(0.00001))
            ax1.yaxis.set_major_locator(ticker.MultipleLocator(0.00005))
            ax1.yaxis.set_minor_locator(ticker.MultipleLocator(0.00001))
            ax.tick_params(axis='both',which='both',direction='in',bottom=True,top=True,left=True,right=True)
            ax.tick_params(axis='both',which='major',length=axmajlen)
            ax.tick_params(axis='both',which='minor',length=axminlen)
            ax.tick_params(axis='both',which='both',width=axwidth)
