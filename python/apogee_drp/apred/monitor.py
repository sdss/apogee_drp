...
def monitor(instrument='apogee-n', apred='daily', clobber=True, makesumfiles=True, exptable=False,
    ...
    html.write('<li> <a href=#qfwhm>Quartz lamp line FWHM</a>\n')
    html.write('<li> <a href=#dflux>Dome flat median flux</a>\n')
    html.write('<li> <a href=#dpos>Dome flat line position </a>\n')
    html.write('<li> <a href=#dfwhm>Dome flat line FWHM</a>\n')
    html.write('<li> <a href=#fpiflux>FPI line flux</a>\n')
    html.write('<li> <a href=#fpipos>FPI line position</a>\n')
    html.write('<li> <a href=#fpifwhm>FPI line FWHM</a>\n')
    html.write('<li> <a href=#tflux>ThAr line flux</a>\n')
    html.write('<li> <a href=#tpos>ThAr line position</a>\n')
    html.write('<li> <a href=#tfwhm>ThAr line FWHM</a>\n')
    html.write('<li> <a href=#uflux>UNe line flux</a>\n')
