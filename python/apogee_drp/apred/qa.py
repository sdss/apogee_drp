...
def makeObsQAplots(load=None, ims=None, plate=None, mjd=None, instrument=None, apred=None,
    ...
    for i in range(n_exposures):
        ...
        ax1.scatter(xx, yy, marker='s', s=125, c='white', edgecolors=cc, cmap=gdcmap, alpha=1, vmin=0.9, vmax=1.1, label='science')

        xx = platesum2['ZETA'][fibertelluric]
        yy = platesum2['ETA'][fibertelluric]
        cc = skylines['FLUX'][0][fibertelluric] / medsky
        ax1.scatter(xx, yy, marker='d', s=125, c='white', edgecolors=cc, cmap=gdcmap, alpha=1, vmin=0.9, vmax=1.1, label='telluric')
