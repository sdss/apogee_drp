    ...
    for j in range(300):
        ...
        if fiber > 0:
            ...
            if (objtype != 'SKY') & (objid != '2MNone'):
                ...
                starHTML.write('<TH bgcolor="#FFFB3">Gaia DR2<BR>PMRA<BR>(mas) <TH bgcolor="#FFFB3">Gaia DR2<BR>PMDEC<BR>(mas) <TH bgcolor="#FFFB3">Gaia DR2<BR>G<BR>(mag) <TH bgcolor="#FFFB3">Mean<BR>Vhelio<BR>(km/s)') 
