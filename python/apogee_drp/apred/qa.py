            ...
            if makespecplots is True:
                ...
                if (len(ymxsec1) == 0) | (len(ymxsec2) == 0) | (len(ymxsec3) == 0) | (len(ymxsec4) == 0) | (len(ymxsec5) == 0): 
                    ...
                    if objtype == 'SKY':
                        ...
                        ax1.text(16811.111, ymin+yspan*0.05, 'H I', color=hcolor, bbox=bboxpar, fontsize=fsz)
                        ax1.text(15412.667, ymin+yspan*0.05, 'Mn II', color=mn2color, bbox=bboxpar, fontsize=fsz)
                        ax1.text(15961.157, ymin+yspan*0.05, 'Ce III', color=ce3color, bbox=bboxpar, fontsize=fsz)
