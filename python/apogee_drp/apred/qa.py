...
def makeObsHTML(load=None, ims=None, imsReduced=None, plate=None, mjd=None, field=None,
    ...
    html.write('Field: <FONT COLOR="green">' + field + '</FONT><BR>Plate: <FONT COLOR="green">' + plate)
...
#    print,'looking for missing reduced data...'
    ...
    html.write('<TR><TD><A HREF='+relpath1+' target="_blank"><IMG SRC='+relpath1+' HEIGHT=225></A>\n')
    html.write('<TD><A HREF='+relpath2+' target="_blank"><IMG SRC='+relpath2+' HEIGHT=225></A>\n')
    html.write('</TABLE>\n')
    ...
    #    html.write('<TR><TD>FIELD<TD>Program<TD>ASPCAP<br>'+apred_vers+'/'+aspcap_vers+'<TD>PLATE<TD>MJD<TD>LOCATION<TD>RA<TD>DEC<TD>S/N(red)<TD>S/N(green)<TD>S/N(blue)\n')
        ...
        for i in range(nplates): 
            ...
            if fps:
                ...
                plug = yanny.yanny(plugmapfile, np=True)
                tra = float(plug['raCen'])
                tdec = float(plug['decCen'])
