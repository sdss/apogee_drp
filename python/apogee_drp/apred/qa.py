...
def makeObsQAplots(load=None, ims=None, imsReduced=None, plate=None, mjd=None, instrument=None,
    ...
    for i in range(2):
        ...
        if (os.path.exists(plotsdir+plotfile) is False) | (clobber is True):
            ...
            psci = ax.scatter(x, y, marker='*', s=210, edgecolors='k', alpha=0.8, c=scicol, cmap='tab10', vmin=0, vmax=10, label='science')
            ...
            fig.subplots_adjust(left=0.06,right=0.95,bottom=0.095,top=0.98,hspace=0.2,wspace=0.0)
