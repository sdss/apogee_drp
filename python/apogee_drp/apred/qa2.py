...
#                import pdb; pdb.set_trace()
                ...
                for ichip in range(nchips):
                    ...
                    ax3.semilogy(x, y, marker='o', ms=10, mec='k', alpha=alpha, mfc=c[ichip], linestyle=None)
#                    ax3.scatter(x, y, marker='o', s=50, edgecolors='k', alpha=alpha, c=c[ichip])
                    x = plSum2['HMAG'][telluric];   y = plSum2['SN'][telluric,i,ichip]
                    ax3.semilogy(x, y, marker='^', ms=11, mec='k', alpha=alpha, mfc=c[ichip], linestyle=None)
