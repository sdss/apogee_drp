...
#    html.write('</TABLE>\n')
    ...
    html.write('<p> Note: in the Mag plots, the solid line is the target line for getting S/N=100 for an H=12.2 star in 3 hours of exposure time.</p>\n')
...
def masterQAplots(load=None, ims=None, plate=None, mjd=None, instrument=None, apred=None,
    ...
    for ichip in range(nchips):
        ...
        sc = ax.scatter(platesum2['Zeta'], platesum2['Eta'], marker='o', s=100, c=med[ypos], edgecolors='k', cmap='jet', alpha=1, vmin=0.3, vmax=1.8)
    ...
    fig.subplots_adjust(left=0.052,right=0.99,bottom=0.08,top=0.90,hspace=0.05,wspace=0.05)
    plt.savefig(plotsdir+plotfile)
    plt.close('all')
...
#            if (makeSpectrumPlots is True) & (j<100):
                print("Making "+plotfile)
