...
def getidents(catalogid=None,sdss_id=None,apogee_id=None):
    """
...
################################
# This is the old code using the xmatch tables directly

def getdataold(catid=None,ra=None,dec=None,designid=None,dcr=1.0,
