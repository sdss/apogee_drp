...
class ApSpec() :
    ...
    def write(self,filename,overwrite=True) :
        ...
        base_header['CRVAL1'] = hdu.header['CRVAL1']
        base_header['CDELT1'] = hdu.header['CDELT1']
        base_header['CRPIX1'] = hdu.header['CRPIX1']
        base_header['CTYPE1'] = hdu.header['CTYPE1']
        fheader = base_header.copy()
        fheader['BUNIT'] = 'Flux (10^-17 erg/s/cm^2/Ang)'
        fheader['EXTNAME'] = 'FLUX'
        hdulist.append(fits.ImageHDU(self.flux,header=fheader))
        eheader = base_header.copy()
        eheader['BUNIT'] = 'Err (10^-17 erg/s/cm^2/Ang)'
        eheader['EXTNAME'] = 'ERROR'
        hdulist.append(fits.ImageHDU(self.err,header=eheader))
        mheader = base_header.copy()
        mheader['BUNIT'] = 'Pixel bitmask'
        mheader['EXTNAME'] = 'MASK'
        hdulist.append(fits.ImageHDU(self.bitmask,header=mheader))
        sfheader = base_header.copy()
        sfheader['BUNIT'] = 'Sky (10^-17 erg/s/cm^2/Ang)'
        sfheader['EXTNAME'] = 'SKY FLUX'
        hdulist.append(fits.ImageHDU(self.sky,header=sfheader))
        seheader = base_header.copy()
        seheader['BUNIT'] = 'Sky error (10^-17 erg/s/cm^2/Ang)'
        seheader['EXTNAME'] = 'SKY ERROR'
        hdulist.append(fits.ImageHDU(self.skyerr,header=seheader))
        theader = base_header.copy()
        theader['BUNIT'] = 'Telluric'
        theader['EXTNAME'] = 'TELLURIC'
        hdulist.append(fits.ImageHDU(self.telluric,header=theader))
        teheader = base_header.copy()
        teheader['BUNIT'] = 'Telluric error'
        teheader['EXTNAME'] = 'TELLURIC ERROR'
        hdulist.append(fits.ImageHDU(self.telerr,header=teheader))
