...
from apogee_drp.apred.visit.output import (
    PIXEL_BITS,
    STAR_BITS,
    build_visit_hdul,
...
def _frame(nfiber=4, npix=40):
    frame = {"fluxcorr": np.full(nfiber, 2.5e-17, dtype=np.float32)}
